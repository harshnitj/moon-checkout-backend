...
const DEFAULT_SETTINGS = {
  ...
  codToastEnabled: true,
  onlineToastEnabled: true,
  advanceToastEnabled: true,
  emailEnabled: true,
  emailRequired: true,
  nameMinLength: 2,
  nameMaxLength: 50,
...
function serializeSettings(settings, options = {}) {
  return {
    ...
    codToastEnabled: settings.codToastEnabled !== false,
    onlineToastEnabled: settings.onlineToastEnabled !== false,
    advanceToastEnabled: settings.advanceToastEnabled !== false,
